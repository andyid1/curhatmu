...
/**
 * `CustomCurhatmuTheme`
 * `CustomCurhatmuTheme based on modern flex design system`
 ...
 * @element custom-curhatmu-theme
 */
class CustomCurhatmuTheme extends PolarisFlexTheme {
  //styles function
  static get styles() {
    return [
      super.styles,
...
customElements.define(CustomCurhatmuTheme.tag, CustomCurhatmuTheme);
export { CustomCurhatmuTheme };
